...
This portfolio showcases everything I learn and build along the way.

## 🛠️ Skills I am learning
| Skill | Status |
|-------|--------|
| Microsoft Excel — Pivot Tables, Charts, Sorting | ✅ In Progress |
| SQL — Oracle Database | 🔜 Coming Soon |
